...
namespace VideoTesterTests {
  public class ValidateVideoInfoTests {
    ...
    public void shouldReturnFailureReasonHapNotDivisbleByFour() {
      ...
      Assert.AreEqual(ResolutionValidationFailureReason.NotDivisbleByFourWidth |
                          ResolutionValidationFailureReason.NotDivisbleByFourHeight,
                      failureReason);
    }
    ...
    public void shouldReturnFailureReasonHapNotDivisbleByFourAndWidthAndHeightTooBig() {
      ...
      ResolutionValidationFailureReason failureReason;
      Assert.IsFalse(v.ResolutionValid(c, out failureReason));
      Assert.AreEqual(ResolutionValidationFailureReason.HeightTooLarge |
                          ResolutionValidationFailureReason.WidthTooLarge |
                          ResolutionValidationFailureReason.NotDivisbleByFourWidth |
                          ResolutionValidationFailureReason.NotDivisbleByFourHeight,
                      failureReason);
    }
