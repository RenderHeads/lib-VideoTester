...
namespace LibVideoTester.Models
{
    ...
    {
        public static ResolutionValidationFailureReason AppendIfFalse(this ResolutionValidationFailureReason current, ResolutionValidationFailureReason toAppend, bool isTrue)
        {
            if (isTrue)
            {
                return current;
